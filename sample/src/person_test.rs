...
mod person_test{
    ...
    fn test_without_blake3hash(){
        let mut person1 =  Person::new(String :: from("abc123"), 0, false);
    ...
    fn test_use_blake3hash(){
        let mut person2 =  Person::new(String :: from("Zalora--999"), 0, false);
    ...
    #[test]
    fn person_get_age5(){
        let person4 =  Person::new(String :: from("alex"), 13, false);
        assert_eq!(13, person4.get_age());
    } 

    #[test]
    fn person_can_walked6(){
        let person5 =  Person::new(String :: from("alex"), 13, true);
